      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          {topPaths.slice(0, 3).map(([domain]) => (
            <div
              key={domain}
              className="bg-gradient-to-br from-indigo-50 to-purple-100 border border-indigo-200 rounded-2xl p-5 text-center shadow-sm"
            >
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-10 shadow-sm">
          ...
          <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
            Your responses suggest you have a strong interest in{" "}
            <b>{topPaths[0][0]}</b> and related fields. You’re naturally
            inclined toward tasks that match your <b>{personalityType}</b>{" "}
            nature.
          </p>
        </div>
