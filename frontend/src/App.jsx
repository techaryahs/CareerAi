...
import UploadReceipt from "./components/PremiumPlans/UploadReceipt";
import ActivityTracker from "./components/ActivityTracker/ActivityTracker";
import BookSlot from "./pages/videocall/BookSlot";
import VideoCallPage from "./pages/videocall/VideoCallPage";
import { WebRTCProvider } from "./webrtc/context/WebRTCContext";
// import CareerRoadmap from "./pages/student/CareerRoadMap/CareerRoadmap";
        ...
        <Router>
          ...
          <Routes>
            ...
            <Route element={<ProtectedRoute allowedRoles={["student"]} />}>
              ...
              />
              <Route
                path="/services/study-abroad/visa"
                element={<VisaGuide />}
              />
              <Route
            ...
            <Route
              element={
                <ProtectedRoute
                  allowedRoles={["student", "teacher", "consultant"]}
                />
              }
            >
              <Route
